...
class InStock4ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ZHDropDownMenuDelegate {

    @IBOutlet weak var filterDropDownMenu: ZHDropDownMenu!
    @IBOutlet weak var instock4TableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        instock4TableView.delegate = self
        instock4TableView.dataSource = self

        let nib = UINib(nibName: "ItemListTableViewCell", bundle: nil)
        instock4TableView.register(nib, forCellReuseIdentifier: "ItemListTableCell")
        ...
        self.ref.child("items/mxI0h7c9GlR1eVZRqH8Sfs1LP6B2").observeSingleEvent(of: .value) { (snapshot) in
            ...
            self.items = allItems
            self.instock4TableView.reloadData()
        }
    }
