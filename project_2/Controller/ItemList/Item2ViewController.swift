...
class Item2ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ZHDropDownMenuDelegate {

    @IBOutlet weak var filterDropDownMenu: ZHDropDownMenu!
    @IBOutlet weak var item2TableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        item2TableView.delegate = self
        item2TableView.dataSource = self
        
        let nib = UINib(nibName: "ItemListTableViewCell", bundle: nil)
        item2TableView.register(nib, forCellReuseIdentifier: "ItemListTableCell")
        ...
        self.ref.child("items/mxI0h7c9GlR1eVZRqH8Sfs1LP6B2").observeSingleEvent(of: .value) { (snapshot) in
            ...
            self.items = allItems
            self.item2TableView.reloadData()
        }
    }
