...
class Item1ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, ZHDropDownMenuDelegate {

    @IBOutlet weak var filterDropDownMenu: ZHDropDownMenu!
    @IBOutlet weak var item1TableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        item1TableView.delegate = self
        item1TableView.dataSource = self
        
        let nib = UINib(nibName: "ItemListTableViewCell", bundle: nil)
        item1TableView.register(nib, forCellReuseIdentifier: "ItemListTableCell")
        ...
        self.ref.child("items/mxI0h7c9GlR1eVZRqH8Sfs1LP6B2").observeSingleEvent(of: .value) { (snapshot) in
            ...
            self.item1TableView.reloadData()
        }
    }
